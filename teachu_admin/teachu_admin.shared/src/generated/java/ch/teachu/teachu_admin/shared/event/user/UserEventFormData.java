 ...
 */
@Generated(value = "ch.teachu.teachu_admin.client.event.user.UserEventForm", comments = "This class is auto generated by the Scout SDK. No manual modifications recommended.")
public class UserEventFormData extends AbstractFormData {
  ...
  public UserEventState getUserEventState() {
    return getFieldByClass(UserEventState.class);
  }

  public UserEventType getUserEventType() {
    return getFieldByClass(UserEventType.class);
  }
  ...
  public static class UserEventState extends AbstractValueFieldData<String> {
    private static final long serialVersionUID = 1L;
  }

  public static class UserEventType extends AbstractValueFieldData<String> {
    private static final long serialVersionUID = 1L;
  }
