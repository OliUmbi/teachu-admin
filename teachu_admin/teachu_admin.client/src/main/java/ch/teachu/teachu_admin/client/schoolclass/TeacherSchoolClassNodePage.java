...
import ch.teachu.teachu_admin.client.schoolclass.subject.TeacherSchoolClassSubjectTablePage;
...
public class TeacherSchoolClassNodePage extends AbstractPageWithNodes {
  ...
  protected void execCreateChildPages(List<IPage<?>> pageList) {
    pageList.add(new TeacherSchoolClassSubjectTablePage(schoolClassId));
